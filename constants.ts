...
export const PROFILE = {
  ...
  bio: `I am a Senior Research Scientist on the {{LINK|NVIDIA Nemotron|https://nemotron-ai.com/}}, where I work on language model systems training. Previously, I was a Senior Research Scientist at {{LINK|Tencent HY LLM (Seattle)|https://hy.tencent.ai/}}, working on visual agentic models and multi-modal LLMs. My research focuses on building agentic LLM systems.
  
  Before moving to industry, I held postdoctoral research positions at {{LINK|Carnegie Mellon University|https://www.ml.cmu.edu/}} and {{LINK|ETH Zurich|https://ethz.ch/en.html}}. Across my Ph.D. and postdoctoral work, my research spanned computer vision, 3D vision, and robotics. I received my Ph.D. from the {{LINK|CSE Department|https://www.cse.ust.hk/}} at {{LINK|HKUST|https://www.ust.hk/}} in 2023; during my doctoral studies, I also spent two years as a visiting scholar in the Computer Vision Lab at ETH Zurich. I received my B.E. from the School of Computer Science at {{LINK|Wuhan University|https://en.wikipedia.org/wiki/Wuhan_University}}. My work has been integrated into the {{LINK|Hugging Face Transformers library|https://huggingface.co/docs/transformers/main/model_doc/sam_hq}}, and my open-source projects have earned over {{BOLD|10K GitHub stars}}.`,
...
export const NEWS: NewsItem[] = [
  ...
  { id: 'n3', date: "2025.08", content: "I will serve as an Area Chair at ICLR 2026." },
  { id: 'n4', date: "2025.03", content: "I will serve as an Area Chair at NeurIPS 2025." },
  { id: 'n5', date: "2024.11", content: "Invited guest lecture at Texas A&M University on Vision Foundation Model." },
  { id: 'n6', date: "2024.04", content: "Joined CMU as a postdoc to work with Prof. Katerina Fragkiadaki, and if you're passionate about vision / robotics with extensive research experience, feel free to reach out for research collaboration!" },
  { id: 'n7', date: "2023.11", content: "We released the Gaussian Grouping project.", link: "https://github.com/lkeab/gaussian-grouping" },
  { id: 'n8', date: "2023.11", content: "Talks on Scene Understanding with Vision Foundation Models at Stanford SVL and MARVL." },
  { id: 'n9', date: "2023.06", content: "We released the HQ-SAM and SAM-PT projects.", link: "https://github.com/SysCV/sam-hq" },
  { id: 'n10', date: "2023.06", content: "Technical committee of VOTS 2023 Challenge. The workshop will take place on October 3rd @ICCV2023." },
  { id: 'n11', date: "2023.05", content: "Passed the PhD thesis defense and become a Dr.!" },
  { id: 'n12', date: "2023.03", content: "Mask-free VIS is accepted in CVPR 2023.", link: "https://arxiv.org/abs/2303.15904" },
  { id: 'n13', date: "2023.01", content: "BCNet is accepted in TPAMI 2023.", link: "https://ieeexplore.ieee.org/document/10048550" },
  { id: 'n14', date: "2022.07", content: "Video Mask Transfiner on high-quality VIS is accepted by ECCV 2022! We released the HQ-YTVIS dataset.", link: "https://arxiv.org/abs/2207.14012" },
  { id: 'n15', date: "2022.03", content: "PCAN serves as the baseline in BDD100K MOTS challenge at CVPR 2022 Workshop on Autonomous Driving." },
  { id: 'n16', date: "2022.03", content: "Mask Transfiner on high-quality instance segmentation is accepted by CVPR 2022!", link: "https://arxiv.org/abs/2111.13673" },
  { id: 'n17', date: "2022.03", content: "Invited talk on PCAN at AI Time Seminar, Tsinghua Univ (Virtual)." },
  { id: 'n18', date: "2022.02", content: "Invited talk on Mutltiple Object Tracking & Segmentation in Autonomous Driving at TechBeat." },
  { id: 'n19', date: "2021.12", content: "Invited spotlight talk for PCAN at SwissTech Convention Center, EPFL." },
  { id: 'n20', date: "2021.10", content: "PCAN for Multiple Object Tracking and Segmentation is accepted by NeurIPS 2021 as spotlight." },
  { id: 'n21', date: "2021.07", content: "Our paper on occlusion-aware video inpainting accepted by ICCV 2021." },
  { id: 'n22', date: "2021.01", content: "I joined CVL at ETHz as a visiting PhD student supervised by Prof.Fisher Yu and Dr.Martin Danelljan." },
  { id: 'n23', date: "2021.03", content: "Our paper BCNet on occlusion-aware instance segmentation accepted by CVPR 2021!" },
  { id: 'n24', date: "2021.10", content: "Passed the PhD Qualifying Exam." },
  { id: 'n25', date: "2020.07", content: "Two papers (GSNet and CPMask) accepted by ECCV 2020." },
  { id: 'n26', date: "2020.02", content: "Our paper on 3D human pose estimation has been accepted by CVPR 2020 for oral presentation." },
  { id: 'n27', date: "2019.07", content: "Our paper on image captioning accepted by ICCV 2019." },
  { id: 'n28', date: "2019.05", content: "I will start my Ph.D study at CSE, HKUST this autumn." },
  { id: 'n29', date: "2019.02", content: "Our paper on video captioning accepted by CVPR 2019." }
];

const CATEGORY_VLM = "VLMs and Agentic LLMs";
...
export const PUBLICATIONS: Publication[] = [
  // --- Vision Language Models ---
  {
    ...
    authors: [coAuthor("Tencent HY Frontier Team"), { name: "Lei Ke", isMe: true, note: "(Project Co-Lead)" }],
    venue: "arXiv 2026",
    year: 2026,
...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    id: 'e0-tencent',
    role: "Senior Research Scientist",
    institution: "Tencent HY LLM (Seattle)",
    period: "2025.03 — 2026.08",
    description: "",
    logo: "images/tencent-hunyuan-logo.svg"
  },
  {
    id: 'e1',
    role: "Postdoc",
